...
- [ ] T-203 — Incrementally extract Flask blueprints/services around identity, workflows, media, and analytics. Depends on: T-101, T-202. Classification: SAFE_INCREMENTAL. First increment (Issue #1, 2026-09-24): notification/onboarding blueprints extracted with behavior tests; pending PR review. Remaining identity, workflow, profile, media, and analytics extraction stays open; do not combine it with T-104/T-201 ownership/schema changes.
