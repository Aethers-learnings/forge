...
- [ ] T-005 — **Next P0.** Disable debug/demo login outside local development and add deployment configuration checks. Depends on: T-001. Classification: SAFE_INCREMENTAL.
