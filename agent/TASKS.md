...
- [ ] T-004 — **Next P0.** Make mobile production navigation HTTPS-only and allowlisted; disable cleartext/mixed content; add configuration tests. Depends on: T-001. Classification: SAFE_INCREMENTAL.
